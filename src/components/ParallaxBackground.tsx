...
const ParallaxBackground: React.FC<Props> = ({ backdropBlurAmount = "none", className = "", color = "#DE443B" }) => {
  ...
  const blurClass = blurClassMap[backdropBlurAmount] || blurClassMap.none;
